    ...
    <b-card :class="isDark ?'bg-dark text-light' : ''">
      ...
      <div v-if="showAllSentences">
        <p v-if="chosenCase.type === 'traffic infraction'">
          <span v-if="prosecutionSentences[0].fine !== 0">Your Honor, I would like to request a fine of {{ prosecutionSentences[0].fine }}$ for the defendant's traffic infraction,
